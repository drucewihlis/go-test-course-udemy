...
func main() {
	var app application
	flag.StringVar(&app.Domain, "domain", "example.com", "Domain for aplication, e.g. company.com")
	...
	flag.StringVar(&app.JWTSecret, "jwt-secret", "MyveryownsecretMyveryownsecretMyveryownsecret", "signing secret")
	flag.Parse()
